            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    <li class="visible-xs-block">
                        <div class="nav-avatar">
                            <img class="img-circle" src="{{ Auth::user()->google->avatar }}?sz=50" alt="" width="48" height="48">
                        </div>
                        <h4 class="navbar-text text-center">Welcome, {{ Auth::user()->name }}!</h4>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <span class="nav-cell p-r-10">
                    <img class="img-circle" src="{{ Auth::user()->google->avatar }}?sz=50" alt="" width="32" height="32">
                  </span>
